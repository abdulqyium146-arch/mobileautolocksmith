    ...
    <>
      ...
      <section className="section bg-white" aria-labelledby="lockout-heading">
        <div className="container max-w-3xl">
          ...
          <div className="space-y-4 text-muted leading-relaxed">
            <p>
              If your keys are locked inside the car, don&apos;t smash a window. Our
        ...
        <div className="container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: Key, title: 'All Makes & Models', desc: 'From a Ford Fiesta to a BMW X5 — we have the equipment and knowledge for every vehicle.' },
