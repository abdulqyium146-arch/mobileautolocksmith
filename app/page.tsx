...
const HOMEPAGE_FAQS = [
  ...
  },
  {
    ...
    answer: `Yes — if your keys are locked inside the car, our car unlock service opens the vehicle without any damage to doors, glass, or seals. We use specialist non-destructive entry tools. While we're on-site we can also cut a spare key so you're never locked out again. Call ${SITE.phone} and we'll come to you.`,
  },
  {
        ...
        <div className="container relative">
          <div className="max-w-3xl">
            ...
            <p className="text-white/80 text-xl leading-relaxed mb-4 max-w-2xl">
              Our mobile auto locksmiths come to you anywhere across the North West —
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted leading-relaxed">
                ...
                <p>
                  When you call us, you speak to Ian or Adam directly. You get a straight
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 id="dealer-heading" className="font-heading font-black text-3xl md:text-4xl text-white mb-4">
              Why Call Us Instead of the Main Dealer?
            </h2>
          </div>
