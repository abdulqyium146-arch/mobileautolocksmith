...
function buildCityFAQs(loc: ReturnType<typeof getLocationBySlug>) {
  ...
  return [
    ...
    },
    {
      ...
      answer: `Absolutely. We operate 24 hours a day, 7 days a week, 365 days a year — including all bank holidays. A key emergency doesn't pick a convenient time, and neither do we. Ian or Adam will answer your call personally whenever you need us in ${loc.name}.`,
    },
    {
