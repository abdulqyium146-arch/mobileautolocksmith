...
const FAQS = [
  {
    ...
    answer: `St Helens is firmly within our core coverage area — Ian and Adam regularly serve WA9, WA10, WA11, and WA12 postcodes. In most cases, response time is within one hour. The A580 and M6 connections mean access to most parts of St Helens is straightforward. Call ${SITE.phone} for a firm ETA.`,
  },
  {
    question: "Can you replace car keys in St Helens if I have no spare?",
    answer: `Yes. The majority of our St Helens call-outs are for drivers who have lost their only key. We work from the vehicle identification number and the lock profile to generate a new key from scratch, without needing an original as a reference. The car stays where it is — we come to it.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Yes, completely. We operate 24 hours a day, 7 days a week, 365 days a year — this includes Saturday nights, Sunday mornings, and bank holidays. There is no reduced-hours service and no answering machine. Ian or Adam will answer personally whenever you call.`,
  },
]
      ...
      <section className="section bg-white" aria-labelledby="sthelens-body-heading">
        <div className="container max-w-3xl">
          ...
          <div className="space-y-5 text-muted leading-relaxed">
            ...
            <p>
              As with all our jobs, the process is: call, get a firm quote, wait for Ian or
