...
export const metadata: Metadata = {
  ...
  description: `See examples of Mobile Auto Locksmith's work — car key replacement, mobile workshop, and on-site service across the North West. Call ${SITE.phone}.`,
