...
export const metadata: Metadata = {
  ...
  title: {
    default: `Auto Locksmith Wigan & St Helens | Mobile Auto Locksmith — ${SITE.phone} | 24/7`,
  ...
  verification: { google: 'aJuAjPAvPDbC-rMbtEXMqoEvLtot3n0hFshvrSapm_U' },
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  twitter: {
    card: 'summary',
    title: `Auto Locksmith Wigan & St Helens | Mobile Auto Locksmith — 24/7`,
