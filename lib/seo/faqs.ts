  ...
  return [
    {
      ...
      answer: `In most cases, Ian or Adam can reach ${loc.name} within one hour of your call. ${loc.name} is well within Mobile Auto Locksmith's regular coverage area. Call ${PHONE} and we'll give you a firm arrival time straight away.`,
    },
    {
